...
char     *ft_type_lf(t_bits *st_bits, va_list *ap, int b_lf) // float and double
{
    char        *i_value;
    float       fvalue;
    double      dvalue;
...
char     *ft_type_Lf(t_bits *st_bits, va_list *ap) // long double
{
    char            *i_value;
    long double     value;
    ut_data         u_ld;
...
char    *ft_resu_frac(st_expdb *st_exp, int len_frac)
{
    int     index_p;
    char    *temp;
